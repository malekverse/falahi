...
CREATE INDEX IF NOT EXISTS idx_group_buys_item ON group_buys (inventory_item_id);
...
CREATE INDEX IF NOT EXISTS idx_participants_group ON group_buy_participants (group_buy_id);
...
DROP POLICY IF EXISTS "Buyers can join group buys" ON group_buy_participants;
